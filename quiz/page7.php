<?php
  ...
  if(isset($_POST['resp7'])){
    if($_POST['resp7'] == $_SESSION['quest7']){
      $_SESSION['acertos']++;
    }
...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="content">
      ...
      />
      <div class="text">
        <p id="red"><?php echo $_SESSION['nomeUser'];?>, sétima pergunta:</p>
        <p id="yellow">Para começar um código php utilizamos < ?php ? ></p>
      </div>
      <form action="" method="post" class="form">
        <p></p>
        <select name="resp7" id="resp7">
